...
const DEFAULTS = {
  ...
  surcharges: {
    ...
    INTERNATIONAL: { amount: 2200, label: "International Tracked Courier - Oversized packaging required (Vinyl + Can)", description: "Your order contains items that require a larger box. Tracking number provided. All import duties and taxes from the UK included." },
  },
