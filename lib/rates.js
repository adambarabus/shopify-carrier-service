...
const DEFAULTS = {
  shipping: {
    ...
    EU: {
      ...
      heavy: 850,
      threshold: 350,
      label: "International Tracked Courier",
      description: "Tracking number provided. All import duties included.",
    },
    INTERNATIONAL: {
      light: 1200,
      heavy: 1500,
      threshold: 350,
      label: "International Tracked Courier",
      description: "Tracking number provided. All import duties and taxes from the UK included.",
    },
  },
  surcharges: {
    UK: { amount: 600, label: "Royal Mail Tracked 48 (Oversized packaging required)", description: "Your order contains items that require a larger box." },
    EU: { amount: 1000, label: "International Tracked Courier (Oversized packaging required)", description: "Your order contains items that require a larger box. Tracking number provided. All import duties included. " },
    INTERNATIONAL: { amount: 2000, label: "International Tracked Courier (Oversized packaging required)", description: "Your order contains items that require a larger box. Tracking number provided. All import duties and taxes from the UK included." },
  },
