...
const DEFAULTS = {
  shipping: {
    ...
    EU: {
      ...
      heavy: 850,
      threshold: 350,
      label: "International Track-ed Courier",
  ...
  surcharges: {
    ...
    INTERNATIONAL: { amount: 2000, label: "International Tracked Courier - Oversized packaging required (Vinyl + Can)", description: "Your order contains items that require a larger box. Tracking number provided. All import duties and taxes from the UK included." },
  },
