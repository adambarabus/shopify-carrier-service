...
// Packaging weights in grams — only the heaviest is applied per order
...
async function calculateRates(shopifyRequest) {
  ...
  // Resolve box types for all line items
